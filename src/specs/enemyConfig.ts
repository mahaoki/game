...
export const EnemyConfigSchema = z.object({
  // ─── Patrol (Met) ──────────────────────────────────────────
  patrolSpeed: z.number().positive().default(30),
